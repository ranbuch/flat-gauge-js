...
},{"./circle":2,"./common":3,"./edges":4,"./needle":8}],2:[function(require,module,exports){
"use strict";
...
var Icon = function () {
    ...
    Icon.prototype.setImage = function (options) {
        ...
        // image.style.top = '50%';
        // image.style.left = '50%';
        if (typeof options.dimensions.top === 'undefined') options.dimensions.top = 0;
        if (typeof options.dimensions.left === 'undefined') options.dimensions.left = 0;
...
},{"./ampm":1,"./spinner":9,"./timer":10,"./tune":11}],8:[function(require,module,exports){
"use strict";
...
},{"./circle":2,"./common":3}],10:[function(require,module,exports){
"use strict";
...
},{"./circle":2,"./common":3,"./edges":4}],11:[function(require,module,exports){
"use strict";
...
},{"./circle":2,"./common":3,"./edges":4,"./icon":5,"./interfaces":6,"./needle":8}]},{},[7])
